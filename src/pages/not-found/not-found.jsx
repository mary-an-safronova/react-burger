    ...
    <div className={notFoundStyle.wrapper}>
      <div className={notFoundStyle.container}>
        <div className={notFoundStyle.content}>
          ...
          <p className="text text_type_main-default text_color_inactive">Перейти на <Link to='/' className={`${notFoundStyle.link} text text_type_main-default`}>главную</Link></p>
        </div>
      </div>
    </div>
  );
