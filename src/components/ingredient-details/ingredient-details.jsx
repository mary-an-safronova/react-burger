    ...
    return(
        <div>
            ...
            <div className={ingredientDetailsStyles.wrap}>
                <img className={ingredientDetailsStyles.image} src={props.card.image} alt={props.card.image} />
                <p className={`${ingredientDetailsStyles.name} text text_type_main-medium`}>{props.card.name}</p>
